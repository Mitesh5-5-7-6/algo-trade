...
Source comments cite a `plan/NN §X` numbering from a documentation set deleted in commit `c158458`. [`docs/README.md`](docs/README.md) carries a bridge table mapping every one of those numbers to its current home.

Per the single-source-of-truth rule, this README deliberately explains nothing further.
