...
| [architecture/RND_RESEARCH_SPECIFICATION.md](architecture/RND_RESEARCH_SPECIFICATION.md) | The Market R&D system: the data→AI chain, sixteen phases, the eight research rules                                      | Before building anything in the research platform                      |
