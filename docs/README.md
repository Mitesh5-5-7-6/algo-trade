...
| [architecture/CURRENT_STATE.md](architecture/CURRENT_STATE.md)                           | What the repository actually contains today, and every known gap with its evidence and intended phase                   | Before assuming a component exists                                     |
